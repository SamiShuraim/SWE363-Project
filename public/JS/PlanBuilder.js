...
// coursesMap.set("COE 202", new Course("COE 202", 3, "Digital Logic Design","Introduction to information representation and number systems. Boolean algebra and switching theory. Canonical forms: minterms and maxterms. Manipulation and minimization of completely and incompletely specified Boolean functions. Propagation delay, timing diagrams. Primitive and complex gates. Combinational circuits design. Multiplexers, decoders, encoders, comparators, adders. Sequential circuit analysis and design, basic flip-flops, clocking and timing diagrams. Registers, counters. Introduction to Verilog."))
// coursesMap.set("COE 203", new Course("COE 203", 1, "Digital Logic Laboratory","Introduction to information representation, Signals and bits, Logic implementation using discrete logic components (TTL, CMOS). Introduction to Field Programmable Logic Arrays (FPGAs) design flow: design capture (schematic capture, HDL design entry, design verification and test, implementation (including some of its practical aspects), and debugging. Use of CAD tools to design, simulate and implement digital logic circuits on FPGA prototyping boards. Introduction to Verilog."))
...
// coursesMap.set("COE 301", new Course("COE 301", 4, "Computer Organization","Introduction to computer organization, machine instructions, assembly language programming, addressing modes, control flow, assembly-language procedures, translating high-level language constructs into assembly, floating-point arithmetic, CPU performance and metrics, CPU design, datapath and control, pipelined instruction execution, pipeline hazards, memory hierarchy, cache memory. Note: Not to be taken for credit with COE 233."));
...
// coursesMap.set("XE XXX", new Course("XE XXX", 3, "Technical Elective", "Technical course chosen from a list of approved courses related to computer science or software engineering; topics may vary and cover advanced areas within the field."));
// coursesMap.set("ICS 410", new Course("ICS 410", 3, "Programming Languages", "Programming paradigms: Object-oriented, imperative, functional, and logic; Application development in these paradigms; Fundamentals of Language Design: Syntax and semantics; Language implementation: virtual machines; Compilation, interpretation, and hybrid."));
// coursesMap.set("SWE 413", new Course("SWE 411", 0, "Senior Project I", "First part of a two-semester Senior Project; initiation, planning, and execution of a substantial software development project; team-based project work; application of software engineering principles and practices."));
